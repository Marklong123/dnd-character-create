...
export function pickRoleplayPreset(): RoleplayPreset {
  return roleplayPresets[Math.floor(Math.random() * roleplayPresets.length)]!
}

export function pickRoleplayValue(field: keyof RoleplayPreset): string {
  return pickRoleplayPreset()[field]
}
